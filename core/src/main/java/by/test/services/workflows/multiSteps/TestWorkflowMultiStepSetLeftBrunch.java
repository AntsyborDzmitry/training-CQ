...
@Component(label = "Test workflow - process step for Left brunch ", immediate = true, metatype = true)
@Service(WorkflowProcess.class)
@Property(name = "process.label", value = "TestWorkflowMultiStepSetLeftBrunch")
public class TestWorkflowMultiStepSetLeftBrunch implements WorkflowProcess{
    @Reference
    private ResourceResolverFactory resourceResolverFactory;

    private static final Logger LOG = LoggerFactory.getLogger(TestWorkflowMultiStepSetLeftBrunch.class);

    @Override
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap) throws WorkflowException {
        LOG.info("My workfolw process for Left brunch executing");
        ...
        try {
            if(resolver!= null){
                ...
                String text = "Left brunches was executed in  " + fmt.format(ldt);
                if(map !=null){
